...
export const messages = {
  zh: {
    ...
    channels: {
      ...
      customHeaders: '自定义请求头与客户端伪装 (每行一条 Header: Value)',
      customHeadersTip: '支持 {header:X-Name}、{uuid}、{apiKey} 等动态变量提取模板',
      codexPreset: '🎭 模拟 Codex 专享头',
      openaiPreset: '🏢 OpenAI 组织',
      anthropicPreset: '⚡ Anthropic 缓存',
      extractPreset: '📥 客户端提取模板',
  ...
  en: {
    ...
    channels: {
      ...
      customHeaders: 'Custom Headers & Client Spoofing (Header: Value per line)',
      customHeadersTip: 'Supports dynamic variable templates like {header:X-Name}, {uuid}, {apiKey}',
      codexPreset: '🎭 Spoof Codex Client',
      openaiPreset: '🏢 OpenAI Org Header',
      anthropicPreset: '⚡ Anthropic Cache',
      extractPreset: '📥 Extract Client Header',
